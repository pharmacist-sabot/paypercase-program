<template>
  <div class="modal-overlay" @click.self="$emit('close')">
    <div class="modal" style="width:860px;height:680px">
      ...
      <div class="modal__body" style="padding:0;display:flex;flex-direction:column;flex:1;overflow:hidden">
        <!-- Sub-tabs -->
        <div class="sub-tabs" style="padding:0 16px;flex-shrink:0;border-bottom:1px solid var(--border-light)">
          <div
            v-for="tab in tabs"
            :key="tab.key"
            class="sub-tab"
